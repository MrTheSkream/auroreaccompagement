...
import logo from "@/assets/logo-les-petits-rituels.png";
const Hero = () => {
  return <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg mx-auto text-center flex flex-col items-center gap-8">
        ...
        ease: "easeOut"
          ...
          <img src={logo} alt="Logo Les Petits Rituels — bébé endormi dans une main avec couronne florale" className="w-full h-full object-contain animate-float rounded-full" />
        </motion.div>
        ...
        delay: 0.6
          ...
          <a href="#services" className="inline-flex items-center justify-center px-8 py-4 rounded-2xl bg-primary text-primary-foreground font-body font-semibold text-base shadow-warm hover:opacity-90 transition-opacity">
            Découvrir mes soins
          </a>
          <a href="#contact" className="inline-flex items-center justify-center px-8 py-4 rounded-2xl bg-secondary text-secondary-foreground font-body font-semibold text-base shadow-soft hover:opacity-90 transition-opacity">
            Me contacter
          </a>
        </motion.div>
      </div>
